...
public class ChaosGraph extends ApplicationFrame {
	...
	*/
	...
	static int numberOfSamples = 200000;
    ...
    public static void main(String[] args) {
		...
		if (returnedData[3] != null) {
			...
			try {
				sim = classType.getDeclaredConstructor().newInstance();
			} catch (Exception e) {
		...
		if (sim != null) {
			sim.analyzeChaosData(smallestZPoint, largestZPoint);
		}
